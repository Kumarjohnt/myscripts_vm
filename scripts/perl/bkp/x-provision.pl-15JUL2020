...
# disk removal happens with 'config' spec, not 'location'. Not checking size of @vmdkToDlete here. what if we change memory and cpus here: memoryMB, numCPU
