####################################################################################
## Script to failover NS1 cdnorigin record for skyline-itcna.cdnorigin.vmware.com ##
## Maintainer : Neha G							          ##
...
_URL = {
	"url_switch" : "https://api.nsone.net/v1/zones/cdnorigin.vmware.com/skyline-itcna.cdnorigin.vmware.com/A"
}

_PAYLOAD_SC2 = json.dumps({ "zone" : "cdnorigin.vmware.com" ,
                            "domain": "skyline-itcna.cdnorigin.vmware.com",
                            "type": "A",
...
def dig():
        time.sleep(2)
        cmd='dig @dns1.p05.nsone.net skyline-itcna.cdnorigin.vmware.com +short'
        proc=subprocess.Popen(shlex.split(cmd),stdout=subprocess.PIPE)
        out,err=proc.communicate()
	out1 = out.strip()
        print("skyline-itcna.cdnorigin.vmware.com record is resolving to -> " + out)
	sc = "66.170.111.238"
	wdc = "208.91.1.235"
	if out1 == sc:
