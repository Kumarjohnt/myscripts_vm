########################################################################################
## Script to failover NS1 cdnorigin record for console-stg-cloud.cdnswitch.vmware.com  #                 
## Maintainer : Neha G							              ##
...
_URL = {
	"url_switch" : "https://api.nsone.net/v1/zones/cdnswitch.vmware.com/console-stg-cloud.cdnswitch.vmware.com/CNAME"
}

_PAYLOAD_INCAPSULA = json.dumps({ "zone" : "cdnswitch.vmware.com" ,
                            "domain": "console-stg-cloud.cdnswitch.vmware.com",
                            "type": "CNAME",
                            "answers":[{"answer": ["d42lphm.x.incapdns.net."]}] })
...
def dig():
	time.sleep(2)
	cmd='dig @dns1.p05.nsone.net console-stg-cloud.cdnswitch.vmware.com +short'
	proc=subprocess.Popen(shlex.split(cmd),stdout=subprocess.PIPE)
	out,err=proc.communicate()
	print("\nconsole-stg-cloud.cdnswitch.vmware.com is resolving to -> " + out)
