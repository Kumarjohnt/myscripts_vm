########################################################################################
## Script to failover NS1 cdnorigin record for console-cloud.cdnswitch.vmware.com      #                 
## Maintainer : Neha G							              ##
...
_URL = {
	"url_switch" : "https://api.nsone.net/v1/zones/cdnswitch.vmware.com/console-cloud.cdnswitch.vmware.com/CNAME"
}

_PAYLOAD_INCAPSULA = json.dumps({ "zone" : "cdnswitch.vmware.com" ,
                            "domain": "console-cloud.cdnswitch.vmware.com",
                            "type": "CNAME",
                            "answers":[{"answer": ["ab9763m.x.incapdns.net."]}] })

_PAYLOAD_AKAMAI = json.dumps({ "zone" : "cdnswitch.vmware.com" ,
                            "domain":"console-cloud.cdnswitch.vmware.com",
                            "type": "CNAME",
                            "answers":[{"answer": ["cloud.vmware.com.edgekey.net."]}] })
...
def dig():
	time.sleep(2)
	cmd='dig @dns1.p05.nsone.net console-cloud.cdnswitch.vmware.com +short'
	proc=subprocess.Popen(shlex.split(cmd),stdout=subprocess.PIPE)
	out,err=proc.communicate()
	print("\nconsole-cloud.cdnswitch.vmware.com is resolving to -> " + out)
