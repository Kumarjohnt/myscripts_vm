#####################################################################################
## Script to failover NS1 Filter Chain services for api.gtmglb.vmware.com          ##
## Maintainer : Neha G                                                             ##
...
_FEED = {
        ...
        "url_status_sc2" : "https://api.nsone.net/v1/monitoring/jobs/5fc8cc21b9004500ad938fb9",
        "url_status_wdc" : "https://api.nsone.net/v1/monitoring/jobs/5fc8cc983771dd00a917dc5a"
}

_SC2_DOWN = {
        "jobid":"5fc8cc21b9004500ad938fb9",
        "up": False
}
...
_WDC_DOWN = {
	"jobid":"5fc8cc983771dd00a917dc5a",
	"up": False
}
