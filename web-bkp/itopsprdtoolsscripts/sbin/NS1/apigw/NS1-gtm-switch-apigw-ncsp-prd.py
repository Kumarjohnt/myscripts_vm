#####################################################################################
## Script to failover NS1 Filter Chain services for apigw-ncsp.gtmglb.vmware.com   ##
## Maintainer : Neha G                                                             ##
...
_FEED = {
        ...
        "url_status_sc2" : "https://api.nsone.net/v1/monitoring/jobs/5f32cf7984a66a00b164b8a9",
        "url_status_wdc" : "https://api.nsone.net/v1/monitoring/jobs/5f32d05aa7239500aa476c2a"
}

_SC2_DOWN = {
        "jobid":"5f32cf7984a66a00b164b8a9",
        "up": False
}
...
_WDC_DOWN = {
	"jobid":"5f32d05aa7239500aa476c2a",
	"up": False
}
