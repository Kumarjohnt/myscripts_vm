#####################################################################################
## Script to failover NS1 Filter Chain services for apigwstg.gtmglb-stg.vmware.com ##
## Maintainer : Neha G                                                             ##
...
_FEED = {
        ...
        "url_status_sc2" : "https://api.nsone.net/v1/monitoring/jobs/5ee61ee76c4e92008d912939",
        "url_status_wdc" : "https://api.nsone.net/v1/monitoring/jobs/5ee61f4516aed3008d594d74"
}

_SC2_DOWN = {
        "jobid":"5ee61ee76c4e92008d912939",
        "up": False
}
...
_WDC_UP = {
	"jobid":"5ee61f4516aed3008d594d74",
	"up": True
}
