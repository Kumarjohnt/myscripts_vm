...
_PAYLOAD_INCAPSULA = json.dumps({ "zone" : "cdnswitchstg.vmware.com" ,
                            "domain": "cdn-test-1.cdnswitchstg.vmware.com",
                            "type": "CNAME",
                            "answers":[{"answer": ["y7ru4jt.x.incapdns.net."]}] })

_PAYLOAD_AKAMAI = json.dumps({ "zone" : "cdnswitchstg.vmware.com" ,
                            "domain":"cdn-test-1.cdnswitchstg.vmware.com",
                            "type": "CNAME",
...
def dig():
	time.sleep(2)
	cmd='dig @dns1.p05.nsone.net cdn-test-1.cdnswitchstg.vmware.com +short'
	proc=subprocess.Popen(shlex.split(cmd),stdout=subprocess.PIPE)
	out,err=proc.communicate()
	print("\ncdn-test-1.cdnswitchstg.vmware.com is resolving to -> " + out)
