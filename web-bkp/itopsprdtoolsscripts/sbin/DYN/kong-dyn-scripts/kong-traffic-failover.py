...
##this gets the DSF recordset ids based on the label of primary pool####
response, content = http.request('https://api2.dynect.net/REST/DSFRecordSet/O3u_MFeh4yTnz_pCKpXFNKlh3YE/', 'GET', headers={'Content-type': 'application/json', 'Auth-Token':  token})
...
##this gets the DSF record ids based on the label of the primary pool ###
response, content = http.request('https://api2.dynect.net/REST/DSFRecord/O3u_MFeh4yTnz_pCKpXFNKlh3YE/', 'GET', headers={'Content-type': 'application/json', 'Auth-Token':  token})
