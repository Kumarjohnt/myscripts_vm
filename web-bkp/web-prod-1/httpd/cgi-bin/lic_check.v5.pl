...
#-----------------------------------------------------------------------
# $Id: lic_check.pl,v 1.74 2007-12-10 22:54:49 vadim Exp $
#-----------------------------------------------------------------------
# Authors:     vadim
...
my $version = sprintf("%d.%d", q$Revision: 1.74 $ =~ /(\d+)\.(\d+)/);
...
VENDOR_STRING=
["]{0,1}licenseType=(Server|production).*["]{0,1}\s+
...
#
# Revision 1.71  2007-12-10 19:58:49  vadim
# broadening date maching to ignore case
#
